...
class BubblePlanner(BasePlanner):
    ...
    @staticmethod
    def detect_obstacles(radius, obs):
    ...
    @staticmethod
    def calculate_avoidance_direction(obstacle_direction):
